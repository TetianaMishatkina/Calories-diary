            ...
            <StyledMealSection>
                ...
                <StyledDayMeal>
                    ...
                    <StyledSelectSection>
                        ...
                        <CustomSelect dataDetails={dataDetails} postItems={postItems} date={date} mealOfDay="Breakfast" />
                    </StyledSelectSection>
                ...
                <StyledDayMeal>
                    ...
                    <StyledSelectSection>
                        <StyledSelectLabel>Choose a food from list...</StyledSelectLabel>
                        <CustomSelect dataDetails={dataDetails} postItems={postItems} date={date} mealOfDay="Dinner" />
                    </StyledSelectSection>
                </StyledDayMeal>
                <StyledDivider vertical />
                ...
                <StyledDayMeal>
                    ...
                    <StyledSelectSection>
                        <StyledSelectLabel>Choose a food from list...</StyledSelectLabel>
                        <CustomSelect dataDetails={dataDetails} postItems={postItems} date={date} mealOfDay="Supper" />
                    </StyledSelectSection>
                </StyledDayMeal>
